...
void save_data ( )
{
    ...
    file . open ( "DATALEVEL.DAT", ios :: binary  ) ;  // Levels.dat contains all the questions for the quiz
    if ( !file ) ;
...
public :
    ...
    player_data ( ) // constructor for initializing
    {
    ...
    void rules (  ) ;
    void set_price (  ) ;
    void win_level ( ) // To Increment level
    {
        level ++ ;
        set_price ( ) ;
    }
...
void player_data :: get_info ( )
{
    ...
    cout << "----------------------------------------------------------------------------\n"
         << " Hello! " << name << endl
         << " Welcome! to the Game of Who Want To Be A Millionaire !!!\n" ;
    rules (  ) ;
    system ( " pause " ) ;
}
